...
class AuthApi {
  ...
  /// Performs an HTTP 'GET /auth/check-login' operation and returns the [Response].
  Future<Response> checkLoginWithHttpInfo() async {
    // ignore: prefer_const_declarations
    final path = r'/auth/check-login';
  ...
  Future<bool?> checkLogin() async {
    final response = await checkLoginWithHttpInfo();
  ...
  /// Performs an HTTP 'DELETE /auth/logout' operation and returns the [Response].
