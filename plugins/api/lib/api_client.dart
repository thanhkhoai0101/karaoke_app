...
class ApiClient {
  ApiClient({this.basePath = 'http://192.168.1.98:2002', this.authentication,});
    ...
    try {
      switch (targetType) {
        ...
        case 'EmployeeRequest':
          return EmployeeRequest.fromJson(value);
        ...
        case 'PageCustomerResponse':
          return PageCustomerResponse.fromJson(value);
        case 'PageEmployeeResponse':
          return PageEmployeeResponse.fromJson(value);
        case 'PageableObject':
